...
define(function (require, exports, modules) {
  ...
  exports.init = function(json){
    ...
    $.extend(config, json || {});
    var html = '<input id="fileupload" type="file" name="file" data-url="' + config.url +
         '" style="width:180px;" multiple><span class="errmsg" style="color: red"></span>' +
         '<div class="progress progress-success">' +
         '<div class="bar"></div><span class="barPro">0%</span></div>';
      ...
      if(config.uploadBack) {
        ...
        if(config.sendContain){
          ...
          var html = '<div class="checked_img">' +
            '<a href="' + url + '" small="' + url_small + '" oriHeight="' + height + '" oriWidth="' + width +
            '" class="linkImg" target="_blank">' + title +
            '</a>&nbsp;&nbsp;&nbsp;<a class="del_img" style="cursor: pointer;" title="删除">x</a></div>';
